<template>
    <div class="dropdown self-stretch">
        <div @click.prevent="notify" class="btn btn_outlined btn_warning uppercase ltr:ml-auto rtl:mr-auto">Notify</div>
        ...
        <div class="custom-dropdown-menu">
            <div class="flex items-center px-5 py-2">
                ...
                <button @click.prevent="greet" class="btn btn_outlined btn_warning uppercase ltr:ml-auto rtl:mr-auto">Clear All</button>
            </div>
