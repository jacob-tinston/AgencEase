                    ...
                    <td>
                            ...
                            <td valign="top" bgcolor="#383e56" background="assets/top-section-bg-01.jpg">
                                ...
                                <tr>
                                    <td align="center" style="padding:40px 40px 10px 40px;" class="table-container">
                                        <a href="{{ route('accept-invitation', $invite->token) }}" style="background-color: #01c8c8; color: #ffffff; display: inline-block;font-family: 'Lato', Arial, Helvetica, sans-serif; font-size: 16px; line-height: 20px; text-align: center; font-weight: bold; text-decoration: none; padding: 20px 25px; min-width: 150px; -webkit-text-size-adjust: none;">Get Started</a>
                                    </td>
                                </tr>
                                </tbody>
                                </table>
                        ...
                        <tr>
                            ...
                            <td align="left" width="576" style="color:#5a5a5a;text-align:left;padding:20px 0 0 20px;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:bold;font-size:15px;-webkit-font-smoothing:antialiased;line-height:1.4;">
                                Sincerely,<br>
                                Your name, Position @ AwesomeCompany
                            </td>
                        </tr>
                        </tbody>
                        </table>
